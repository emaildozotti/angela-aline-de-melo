...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Antes de qualquer coisa, eu preciso',
  headingEm: 'te falar algo importante',
  preText: 'Neste vídeo, eu falo sobre o que me levou a trabalhar com mulheres como você: mulheres que aprenderam a se anular como se isso fosse virtude. Assiste antes de qualquer decisão.',
  postText: 'Se algo no vídeo tocou em você, continue lendo. O que vem a seguir vai fazer ainda mais sentido.',
}
// ════════════════════════════════════════════════════════════════════
