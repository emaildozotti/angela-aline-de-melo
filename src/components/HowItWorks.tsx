...
const COPY = {
  ...
  heading: 'Três passos simples para dar início à sua reconstrução',
  steps: [
    {
      title: 'Agende sua conversa',
      body: 'Você agenda uma conversa gratuita comigo pelo WhatsApp. Sem compromisso, sem julgamento.',
    },
    {
      title: 'Conversamos juntas',
      body: 'Conversamos sobre o que está tirando sua paz e entendemos juntas o caminho. Você fala, eu escuto de verdade.',
    },
    {
      title: 'Seu processo começa',
      body: 'Se fizer sentido, começamos seu processo de desprogramação e reconstrução. No seu ritmo, com presença e profundidade.',
    },
  ],
  note: 'Você não precisa ter certeza de nada agora. A conversa é gratuita, sem compromisso e sem julgamento.',
