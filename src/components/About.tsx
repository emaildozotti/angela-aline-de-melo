...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  eyebrow: 'quem está do outro lado',
  heading: 'Eu já estive onde',
  headingEm: 'você está agora',
  paragraphs: [
    'Eu era funcionária pública concursada. A vida parecia certa por fora, mas meu corpo gritava. Dores no estômago, vazio, um clamor por propósito que a estabilidade não resolvia.',
    'No silêncio, fui obrigada a ouvir o que evitava. Entendi que minha dor era uma ponte, não o fim. Mergulhei na Psicanálise e na Inteligência Emocional para decifrar a mim mesma.',
    'Hoje uso minha travessia para guiar mulheres que sentem que algo precisa nascer. Eu sustento o confronto porque já o atravessei.',
  ],
  transition: 'Se você sente que chegou a hora de parar de viver pra todo mundo e começar a viver pra você, eu quero te ajudar nesse caminho.',
  ctaText: 'Quero Conhecer Esse Processo',
}
// ════════════════════════════════════════════════════════════════════
