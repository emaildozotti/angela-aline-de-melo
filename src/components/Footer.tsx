...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  eyebrow: 'uma decisão que muda tudo',
  heading: 'Você não precisa continuar',
  headingEm: 'vivendo no apagamento',
  subtitle: 'Existe uma vida do outro lado desse padrão. Uma vida onde você importa, onde você tem voz, onde você existe pra além do que serve aos outros. Esse caminho começa com uma conversa.',
