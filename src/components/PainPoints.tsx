...
const COPY = {
  ...
  pains: [
    ...
    'Faz tudo certo por fora, mas por dentro está desmoronando.',
    'Sente culpa por querer algo só pra você, como se isso fosse egoísmo.',
    'Vive no automático: acorda, serve, sorri, chora escondido e repete.',
  ],
  transition: 'Se você se reconheceu em alguma dessas palavras, você está no lugar certo. O que você sente tem nome, tem origem e tem saída.',
}
// ════════════════════════════════════════════════════════════════════
