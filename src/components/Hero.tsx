...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'MULHERES QUE VIVEM SERVINDO A TODOS',
  h1: 'Você cuida de todo mundo, mas está',
  h1Em: 'se perdendo por dentro',
  subtitle: 'Você faz tudo certo, sustenta a casa, sorri pra família, mas existe um vazio que ninguém vê. Esse cansaço não é fraqueza. É um chamado que você ainda não ouviu.',
